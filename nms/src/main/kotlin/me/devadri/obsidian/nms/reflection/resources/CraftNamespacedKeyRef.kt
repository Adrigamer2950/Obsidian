...
class CraftNamespacedKeyRef(val instance: Any) {
    ...
    companion object {
        ...
        val classRef =
            ReflectionUtil.remapClass(when (NmsVersions.current) {
                ...
                NmsVersions.V1_20_R3 -> "org.bukkit.craftbukkit.${NmsVersions.current.packageFormatted}.util.CraftNamespacedKey"
        ...
        fun toMinecraft(key: NamespacedKey): ResourceLocationRef = ResourceLocationRef.fromNMS(toMinecraftMethod(null, key))
    }
}